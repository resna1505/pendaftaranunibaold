...
// paging
	...
	$query = "SELECT COUNT(*) as num FROM mahasiswa where STATUS='L' ";
	if($type=='tab'){
...
echo "</head>\n";
echo "<body>\n";
echo "\r\n\r\n<div id=\"wrap\">\r\n\t\r\n    <h2 id=\"title\">Daftar Alumni</h2>\r\n    \r\n    <div id=\"link_alpha\">\r\n    \t<ul class=\"mainlink\">\r\n     ";
$i = 0;
while ( $i < 26 )
{
    echo "\r\n             \t<li><a href='listalumni.php?tab=1&pfld=".$pfld."&pfltr=".$pfltr."&type=tab&pnama=".chr( $i + 65 )."'>".chr( $i + 65 )."\r\n         \t</a></li>";
    ++$i;
}
...
echo "<input class='input_text' type=text name=angkatan value='{$angkatan}'>";
echo "        </label>\r\n                \r\n\t  ";
...
//echo "<input type=button class=login  value='Cari!' \r\n     onClick=window.open('listalumni.php?pfld='+'{$pfld}'+'&pfltr='+'{$pfltr}'+'&pnama='+katakunci.value+'&idprodi='+idprodi.value+'&angkatan='+angkatan.value,'_self')>";
echo "    \r\n    </form>\r\n    \r\n    ";
echo "<a class='showall' href='listalumni.php?pfld=".$pfld."&type=semua&pfltr=".$pfltr."'>Tampilkan Semua</a>";
echo "    \r\n    </div>\r\n    \r\n\r\n";
...
// echo "<td class=judul2 width='10'><a href='listalumni.php?tab={$tab}&pfld=".$pfld."&pfltr=".$pfltr."&pnama={$pnama}&porder=N'>NIM</a></td>\n";
// echo "<td class=judul2 ><a href='listalumni.php?tab={$tab}&pfld=".$pfld."&pfltr=".$pfltr."&pnama={$pnama}&porder=U'>Nama</a></td>\n";
// echo "<td class=judul2 ><a href='listalumni.php?tab={$tab}&pfld=".$pfld."&pfltr=".$pfltr."&pnama={$pnama}&porder=P'>Jurusan/Prodi</a></td>\n";
// echo "<td class=judul2 ><a href='listalumni.php?tab={$tab}&pfld=".$pfld."&pfltr=".$pfltr."&pnama={$pnama}&porder=A'>Angkatan</a></td>\n";echo "<td class=judul2 width='10'><a href='listalumni.php?tab={$tab}&pfld=".$pfld."&pfltr=".$pfltr."&pnama={$pnama}&porder=N'>NIM</a></td>\n";
echo "<td class=judul2 ><a href='listalumni.php?$uri&porder=U'>Nama</a></td>\n";
echo "<td class=judul2 ><a href='listalumni.php?$uri&porder=P'>Jurusan/Prodi</a></td>\n";
echo "<td class=judul2 ><a href='listalumni.php?$uri&porder=A'>Angkatan</a></td>\n";
echo "</tr></head>\n";
$i = 0;
